...
include __DIR__ . '/src/ini-set.php';
include __DIR__ . '/src/setErrorExceptionHandler.php';
include __DIR__ . '/src/Logger.php';
include __DIR__ . '/src/ZipArchiveExt.php';
include __DIR__ . '/src/Requirements.php';
include __DIR__ . '/src/RequirementsCheck.php';
include __DIR__ . '/src/Runtime.php';
include __DIR__ . '/src/JsonResponse.php';
include __DIR__ . '/src/Database.php';
include __DIR__ . '/src/Controller.php';
$logger = new Logger(APP_NAME . ' ' . APP_VERSION);
$requirements = new Requirements(
    phpMinimum: PHP_VERSION_MIN,
    phpRecommended: PHP_VERSION_RECOMMENDED,
    phpExtensions: [
        'curl',
        'hash',
        'json',
...
$runtime = new Runtime(settings: $phpSettings, logger: $logger);
$runtime->run();
include __DIR__ . '/src/lock-check.php';
$opts = getopt('a:') ?? null;
if(!empty($_POST)) {
    $params = $_POST;
} else if(!empty($opts)) {
...
if (isset($params)) {
    ...
    if (isset($_GET['getNginxRules'])) {
        require __DIR__ . '/template/nginx.php';
        die();
    }
    if(!empty($opts)) {
        die();
    ...
    $jsVars = $runtime;
    ob_start();
    require __DIR__ . '/template/content.php';
