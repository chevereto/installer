			...
			<div class="products-container">
			  <div class="flex-box product-box product-box--free text-align-center col-8 animate" data-action="choose" data-arg="free">
			     <div>
			        ...
			        <p class="product-box-description">Perfect for personal use. Totally free and upgradable to paid edition.</p>
			     </div>
			  </div>
			  <div class="flex-box product-box product-box--paid text-align-center col-8 animate" data-action="choose" data-arg="paid">
			     <div>
			        ...
			        <img class="product-box-logo">
			        <p class="product-box-description">For pros and big websites. Frequent updates. Tech support included.</p>
			     </div>
			  </div>
			</div>
	  </div>
	  <div class="container container--install animate animate--slow">
			<div class="flex-box box--install col-16">
				<div class="free--show">
					...
					<p>Keep in mind that this is a free product, some sacrifices had to be made. It <a href="https://chevereto.com/support" target="_blank">doesn't include support</a>, it has <a href="https://chevereto.com/free#compare-tier" target="_blank">fewer features</a> and it gets <a href="https://github.com/Chevereto/Chevereto-Free/releases" target="_blank">less</a> <a href="https://chevereto.com/changelog" target="_blank">frequent</a> updates. You can upgrade to paid edition at any time from your dashboard panel.</p>
					<?php
						if($nginx) {
							echo $nginx;
						}
				...
				<div class="paid--show">
					...
					?>
					<p>All previous uploads will be preserved and the database schema will be upgraded to this edition. Please backup your changes.</p>
					<?php
						}
					?>
					<?php
